...
# jinja2 templates
'webapp2_extras.jinja2' : {'template_path': ['templates','justice/templates', 'admin/templates'],
                           'environment_args': {'extensions': ['jinja2.ext.i18n']}},

# application name
'app_name' : "Justice Cloud",
...
'locales' : ['pt_BR','en_US', 'es_ES', 'it_IT', 'zh_CN', 'id_ID', 'fr_FR', 'de_DE', 'ru_RU'],
