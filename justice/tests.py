...
class AppTest(unittest.TestCase, test_helpers.HandlerHelpers):
    ...
    def test_password_reset(self):
        ...
        with patch('justice.lib.captcha.submit', return_value=captcha.RecaptchaResponse(is_valid=False)):
            self.submit(form, expect_error=True, error_message='Wrong image verification code.')
        with patch('justice.lib.captcha.submit', return_value=captcha.RecaptchaResponse(is_valid=True)):
